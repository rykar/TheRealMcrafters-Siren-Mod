...
import mcrafter.SirenMod.client.audio.SirenLooperBlack;
...
public class BlackSirenTileEntity extends TileEntity {
	...
	BlackGeneralSiren siren = new BlackGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperBlack sirenOne = new SirenLooperBlack(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

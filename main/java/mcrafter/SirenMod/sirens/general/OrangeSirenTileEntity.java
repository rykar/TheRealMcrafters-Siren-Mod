...
import mcrafter.SirenMod.client.audio.SirenLooperOrange;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;


public class OrangeSirenTileEntity extends TileEntity {
	...
	OrangeGeneralSiren siren = new OrangeGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperOrange sirenOne = new SirenLooperOrange(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

...
import mcrafter.SirenMod.client.audio.SirenLooperLime;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;


public class LimeSirenTileEntity extends TileEntity {
	...
	LimeGeneralSiren siren = new LimeGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperLime sirenOne = new SirenLooperLime(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

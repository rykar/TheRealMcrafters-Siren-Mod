...
import mcrafter.SirenMod.client.audio.SirenLooperPink;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;


public class PinkSirenTileEntity extends TileEntity {
	...
	PinkGeneralSiren siren = new PinkGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperPink sirenOne = new SirenLooperPink(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

...
import mcrafter.SirenMod.client.audio.SirenLooperYellow;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;
import net.minecraft.world.World;

public class YellowSirenTileEntity extends TileEntity {
	...
	YellowGeneralSiren siren = new YellowGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperYellow sirenOne = new SirenLooperYellow(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

...
import mcrafter.SirenMod.client.audio.SirenLooperBrown;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;


public class BrownSirenTileEntity extends TileEntity {
	...
	BrownGeneralSiren siren = new BrownGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperBrown sirenOne = new SirenLooperBrown(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

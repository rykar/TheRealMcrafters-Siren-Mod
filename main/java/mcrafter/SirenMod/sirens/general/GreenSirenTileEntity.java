...
public class GreenSirenTileEntity extends TileEntity {
	...
	GreenGeneralSiren siren = new GreenGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperGreen sirenOne = new SirenLooperGreen(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

...
import mcrafter.SirenMod.client.audio.SirenLooperGrey;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;

public class GreySirenTileEntity extends TileEntity {
	...
	GreyGeneralSiren siren = new GreyGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperGrey sirenOne = new SirenLooperGrey(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

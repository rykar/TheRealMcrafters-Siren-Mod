...
import mcrafter.SirenMod.client.audio.SirenLooperPurple;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;


public class PurpleSirenTileEntity extends TileEntity {
	...
	PurpleGeneralSiren siren = new PurpleGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperPurple sirenOne = new SirenLooperPurple(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

...
import mcrafter.SirenMod.client.audio.SirenLooperLightGrey;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;


public class LightGreySirenTileEntity extends TileEntity {
	...
	LightGreyGeneralSiren siren = new LightGreyGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperLightGrey sirenOne = new SirenLooperLightGrey(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

...
import mcrafter.SirenMod.client.audio.SirenLooperWhite;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;


public class WhiteSirenTileEntity extends TileEntity {
	...
	WhiteGeneralSiren siren = new WhiteGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperWhite sirenOne = new SirenLooperWhite(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 

...
import mcrafter.SirenMod.client.audio.SirenLooperLightBlue;
import mcrafter.SirenMod.common.SirenMod;
import net.minecraft.client.Minecraft;
import net.minecraft.tileentity.TileEntity;


public class LightBlueSirenTileEntity extends TileEntity {
	...
	LightBlueGeneralSiren siren = new LightBlueGeneralSiren(null);
	...
	public void updateEntity(){
		...
		if (!isPlaying && shouldStart){
            ...
            shouldStop = false; 
            isPlaying = true; 
            SirenLooperLightBlue sirenOne = new SirenLooperLightBlue(worldObj.getTileEntity(xCoord, yCoord, zCoord), "sirenOne"); 
